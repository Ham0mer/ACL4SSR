...
install_x-ui() {
    ...
    if [ $# == 0 ]; then
        tag_version=$(curl -Ls "https://gh-proxy.com/https://api.github.com/repos/MHSanaei/3x-ui/releases/latest" | grep '"tag_name":' | sed -E 's/.*"([^"]+)".*/\1/')
    ...
    wget -O /usr/bin/x-ui https://gh-proxy.com/https://raw.githubusercontent.com/MHSanaei/3x-ui/main/x-ui.sh
